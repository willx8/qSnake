...
void QTile::draw_head() {
    //setText("H");
    setGraphicsEffect(NULL);
    setStyleSheet("QTile { background: rgb(238,228,218);\
     color: rgb(119,110,101); font: bold; border-radius: 1px; font: 1pt; }");
}

void QTile::draw_background() {
    //setText("");
    setGraphicsEffect(NULL);
    setStyleSheet("QTile { background: rgb(204,192,179); border-radius: 1px; }");
}

void QTile::draw_food() {
    //setText("F");
    ...
    setStyleSheet("QTile { background: rgb(237,204,97); color: rgb(255,255,255);\
     font: bold; border-radius: 15px; font: 1pt; }");
}


//void QTile::drawBoard()
//{
//    if (tile == NULL) {
//        setText("");
